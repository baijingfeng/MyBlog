...
- [**big.js**](https://github.com/MikeMcl/big.js) 解决 js 浮点数问题。 主要就是 Big Number 或者小数点，一个用于任意精度十进制算术的小而快速的 JavaScript 库。
...
- [**fuse.js**](https://fusejs.io/getting-started/installation.html) 轻量级前端模糊查询库 非常的好用
...
- [**scroll-out**](https://scroll-out.github.io/) 滚动效果（滚动视差）的框架，框架大小不到 1KB,使用回调的方式将相关动画元素的属性进行实时分配
...
- [**pagemap**](https://larsjung.de/pagemap/) Mini map for web pages 页面导航图
...
- [**awesome-bookmarks**](https://panjiachen.gitee.io/awesome-bookmarks/repository/) panjiachen 的收藏站，也是本网站最初参考的网站。
